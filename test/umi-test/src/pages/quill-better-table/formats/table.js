...
import { TableCellUl, TableCellUlLi } from './tableExtention'
...
class TableCellLine extends Block {
  static create(value) {
    ...
    // console.log(node, 'TableCellLine static create');
...
class TableCell extends Container {
  ...
  static formats(domNode) {
    ...
    const aa = CELL_ATTRIBUTES.reduce((formats, attribute) => {
    ...
    console.log(aa, 'formats', domNode);
    // debugger
...
TableCell.allowedChildren = [TableCellLine, Header, TableCellUl]
TableCellUl.requiredContainer = TableCell
